...
const UPSERT_KEYS_MANIFEST = {
  ...
  game_statistics: {
    ...
    updateColumns: [
      ...
      'red_cards_home', 'red_cards_away', 'offsides_home', 'offsides_away',
      'updated_at'
    ],
    idColumn: 'id'
  },
  ...
  game_player_stats: {
    ...
    updateColumns: [
      'team_id', 'minutes_played', 'goals', 'assists', 'yellow_cards',
      'red_cards', 'shots', 'shots_on_target', 'passes', 'passes_completed',
      'tackles', 'interceptions', 'fouls_committed', 'fouls_suffered', 'rating',
      'updated_at'
    ],
    idColumn: 'id'
  },
